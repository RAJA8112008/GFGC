...
function extractProblemName() {
  try {
    ...
    var heading = document.querySelector(".problem-statement h3") || document.querySelector(".problem-tab__name") || document.querySelector("h1");
    if (heading !== null && heading !== void 0 && (_heading$innerText = heading.innerText) !== null && _heading$innerText !== void 0 && _heading$innerText.trim()) {
...
function initWhenReady() {
  ...
  var tryMount = function tryMount() {
    if (document.body) {
      mountUI();
    }
  };
